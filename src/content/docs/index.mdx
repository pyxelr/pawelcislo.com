...
- Agentic AI & Retrieval-Augmented Generation (RAG) systems with Large Language Models
...
- Consumer of [books](https://goodreads.com/pyxelr)/audiobooks, [podcasts](/recommendations/#-podcasts), and [plenty of online articles](https://hypothes.is/users/pyxelr)
