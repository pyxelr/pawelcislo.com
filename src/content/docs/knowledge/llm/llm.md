...
- [Large Language Model Course](https://github.com/mlabonne/llm-course) ← LLM with roadmaps and Colab notebooks
- [Learn Prompting](https://learnprompting.org/) ← course on communicating with AI such as GPT-3
- [OpenAI Academy](https://academy.openai.com/) ← events/materials from OpenAI about LLMs
...
- Awesome
  ...
  - [Awesome Totally Open Chatgpt](https://github.com/nichtdax/awesome-totally-open-chatgpt) ← list of totally open alternatives to ChatGPT
- [Claude Code Unpacked](https://ccunpacked.dev/) ← What actually happens when you type a message into Claude Code?
- [Gandalf | Lakera](https://gandalf.lakera.ai/) ← make Gandalf reveal the password for each level
- [Generative AI exists because of the transformer](https://ig.ft.com/generative-ai/) ← simple and interactive explanation of how transformers work
- [GPT best practices](https://platform.openai.com/docs/guides/gpt-best-practices) ← written by OpenAI
- [GPTs](https://github.com/linexjlin/GPTs) ← leaked prompts of GPTs (links to ChatGPT bots)
- [How are you using GPT to be so productive?](https://news.ycombinator.com/item?id=35299071) ← Ask HN
- [How does GPT Obtain its Ability? Tracing Emergent Abilities of Language Models to their Sources](https://yaofu.notion.site/How-does-GPT-Obtain-its-Ability-Tracing-Emergent-Abilities-of-Language-Models-to-their-Sources-b9a57ac0fcf74f30a1ab9e3e36fa1dc1) ← Notion article
- [LLM Visualization](https://bbycroft.net/llm) ← source: [tweet](https://twitter.com/BrendanBycroft/status/1731042957149827140)
- [LMSYS Chatbot Arena Leaderboard](https://chat.lmsys.org/?leaderboard) ← leaderboard of LLMs
- [Replacing my best friends with an LLM trained on 500,000 group chat messages](https://www.izzy.co/blogs/robo-boys.html)
- [The GPT-3 Architecture, on a Napkin](https://dugas.ch/artificial_curiosity/GPT_architecture.html) ← explanation of GPT-3 architecture
- [Transformer Explainer](https://poloclub.github.io/transformer-explainer/) ← LLM transformer visually explained
- [Useful Prompt Engineering tools and resources](https://www.reddit.com/r/StableDiffusion/comments/xcrm4d/useful_prompt_engineering_tools_and_resources/) ← Reddit post with resources for talking with GPT
